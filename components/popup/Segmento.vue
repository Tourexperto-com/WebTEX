<template>
    <div v-if="showModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div class="w-[90%] max-w-80 md:max-w-[41rem] flex flex-col gap-4 relative bg-light rounded-2xl mx-4 p-5 md:p-8">
            ...
            <div class="grid md:flex grid-cols-3 justify-center gap-3">
