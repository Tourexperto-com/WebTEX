    ...
    <div class="w-full flex flex-col gap-2">
        <div class="relative">
            ...
            <input :id="id" :type="type" :value="modelValue"
                class="w-full bg-white text-gray-dark text-xs placeholder:gray-dark placeholder:text-xs rounded-full py-3 pl-9 pr-4 focus:outline-none focus:border-transparent"
