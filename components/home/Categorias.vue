        ...
        <CarouselAutoplay :auto-play="true" :auto-play-interval="2500" :show-dots="true" :slides-per-view="{base: 2, sm: 3, md: 4, lg: 5, lg: 6}">
            <NuxtLink to="#" v-for="(categoria, index) in categorias" :key="index"
                ...
                <NuxtImg :src="categoria.img" :alt="categoria.titulo"
                    class="object-cover rounded-[18px]" />
                <div
                    class="flex flex-col justify-end absolute inset-0 bg-gradient-to-t from-[#200033] via-transparent via-60% to-transparent rounded-[18px] px-3 pb-4">
...
const categorias = [
    {
        slug: 'aventura-safaris',
        titulo: 'Aventura y safaris',
        img: '/images/categorias/cruceros.png',
    },
    {
        slug: 'exoticos',
        titulo: 'Exóticos',
        img: '/images/categorias/lgbtq.png',
    },
    {
        slug: 'playas',
        titulo: 'Playas',
    ...
    {
        slug: 'cruceros',
        titulo: 'Cruceros fluviales y marítimos',
        img: '/images/categorias/lgbtq.png',
    },
    {
        slug: 'cultura',
    ...
    {
        slug: 'mujeres',
        titulo: 'Viaje de mujeres',
        img: '/images/categorias/lgbtq.png',
    },
    {
        slug: 'premier',
        titulo: 'Viajes premier',
        img: '/images/categorias/cruceros.png',
    },
    {
        slug: 'wellness',
        titulo: 'Yoga, meditación y spa',
        img: '/images/categorias/lgbtq.png',
    },
]
</script>